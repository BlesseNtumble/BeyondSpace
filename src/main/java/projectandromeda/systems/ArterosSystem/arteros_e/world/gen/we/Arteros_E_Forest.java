...
public class Arteros_E_Forest extends WE_Biome {
	...
	public Arteros_E_Forest() {
		...
		WE_WorldTreeGen tree = new WE_WorldTreeGen();
		tree.add(PABlocks.ARTEROS_E_LOG, 0, PABlocks.ARTEROS_E_LEAVES, 0, Blocks.SAPLING, Blocks.VINE, Blocks.COCOA, 4, 10, 8, false);
