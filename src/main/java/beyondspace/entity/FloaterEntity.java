...
public class FloaterEntity extends EntityFlying implements IMob, IEntityBreathable
{
    ...
    public boolean attackEntityFrom(DamageSource damage, float f)
    {
        ...
        else if ("fireball".equals(damage.getDamageType()) && damage.getEntity() instanceof EntityPlayer)
        {
            super.attackEntityFrom(damage, 1000.0F);
            return true;
        }
        else
        {
    ...
    {
        return "galaxyadditions:floaterLiving";
    }

    protected String getHurtSound()
    {
        return "galaxyadditions:floaterHurt";
    }

    protected String getDeathSound()
    {
        return "galaxyadditions:floaterDeath";
    }
    ...
    protected void dropFewItems(boolean p_70628_1_, int p_70628_2_)
    {
        ...
        for (k = 0; k < j; ++k)
        {
            this.entityDropItem(new ItemStack(RegistrationsList.floaterDrop, 1, 1), 1);
        }
        ...
        for (k = 0; k < j; ++k)
        {
            this.entityDropItem(new ItemStack(RegistrationsList.floaterDrop, 1, 0), 1);
        }
    }
