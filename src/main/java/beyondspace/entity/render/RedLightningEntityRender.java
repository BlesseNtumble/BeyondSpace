...
public class RedLightningEntityRender extends Render {

    public void doRender(RedLightningEntity entity, double x, double y, double z, float pos, float dir) {
    ...
    protected ResourceLocation getEntityTexture(RedLightningEntity entity) {
        return null;
    }

    protected ResourceLocation getEntityTexture(Entity entity) {
        return this.getEntityTexture((RedLightningEntity)entity);
    }

    public void doRender(Entity entity, double x, double y, double z, float pos, float dir) {
        this.doRender((RedLightningEntity)entity, x, y, z, pos, dir);
    }
}
