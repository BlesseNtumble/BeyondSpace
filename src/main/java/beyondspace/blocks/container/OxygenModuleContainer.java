...
public class OxygenModuleContainer extends Container
{
    private UltimateOxygenModuleTileEntity tileEntity;

    public OxygenModuleContainer(InventoryPlayer par1InventoryPlayer, UltimateOxygenModuleTileEntity storageModule)
    {
