...
public class LightningRodBaseContainer extends Container {
	
	private LightningRodBaseTileEntity tileEntity;

	public LightningRodBaseContainer(InventoryPlayer par1InventoryPlayer, LightningRodBaseTileEntity solarGen) {
