...
public class UltimateFurnaceContainer extends Container
{
    private UltimateFurnaceTileEntity tileEntity;

    public UltimateFurnaceContainer(InventoryPlayer par1InventoryPlayer, UltimateFurnaceTileEntity tileEntity)
    {
