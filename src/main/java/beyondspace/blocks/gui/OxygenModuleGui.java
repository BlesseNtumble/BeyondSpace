...
/**
    ...
    {
        String guiTitle = GCCoreUtil.translate("tile.OxygenModule.name");
        ...
        String maxOutputLabel = GCCoreUtil.translate("gui.maxOutput.desc") + ": " + UltimateOxygenModuleTileEntity.OUTPUT_PER_TICK * 20 + GCCoreUtil.translate("gui.perSecond");
    ...
    {
        this.mc.renderEngine.bindTexture(OxygenModuleGui.batteryBoxTexture);
