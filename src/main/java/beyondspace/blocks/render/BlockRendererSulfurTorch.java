...
public class BlockRendererSulfurTorch implements ISimpleBlockRenderingHandler {
	final int renderID;

	public BlockRendererSulfurTorch(int var1) {
		this.renderID = var1;
	}

	@Override
	public boolean renderWorldBlock(IBlockAccess var1, int var2, int var3, int var4, Block var5, int var6, RenderBlocks var7) {
		BlockRendererSulfurTorch.renderGCUnlitTorch(var7, var5, var1, var2, var3, var4);
		return true;
	}
	...
	public void renderInventoryBlock(Block block, int metadata, int modelID, RenderBlocks renderer) {
		BlockRendererSulfurTorch.renderTorchAtAngle(renderer, block, 0, 0, 0, 0.0D, 0.0D);
	}
	...
	public static void renderGCUnlitTorch(RenderBlocks renderBlocks, Block par1Block, IBlockAccess var1, int par2,
		...
		if (var5 == 1) {
			BlockRendererSulfurTorch.renderTorchAtAngle(renderBlocks, par1Block, par2 - var9, par3 + var11, par4, -var7,
					0.0D);
		} else if (var5 == 2) {
			BlockRendererSulfurTorch.renderTorchAtAngle(renderBlocks, par1Block, par2 + var9, par3 + var11, par4, var7,
					0.0D);
		} else if (var5 == 3) {
			BlockRendererSulfurTorch.renderTorchAtAngle(renderBlocks, par1Block, par2, par3 + var11, par4 - var9, 0.0D,
					-var7);
		} else if (var5 == 4) {
			BlockRendererSulfurTorch.renderTorchAtAngle(renderBlocks, par1Block, par2, par3 + var11, par4 + var9, 0.0D,
					var7);
		} else {
			BlockRendererSulfurTorch.renderTorchAtAngle(renderBlocks, par1Block, par2, par3, par4, 0.0D, 0.0D);
		}
	}
