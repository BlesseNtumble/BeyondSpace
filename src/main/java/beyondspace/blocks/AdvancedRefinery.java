...
public class AdvancedRefinery extends BlockAdvancedTile implements IBlockShiftDesc
{
	...
	public void randomDisplayTick(World par1World, int par2, int par3, int par4, Random par5Random)
	{
		...
		if (te instanceof AdvancedRefineryTileEntity)
		{
			final AdvancedRefineryTileEntity refinery = (AdvancedRefineryTileEntity) te;
	...
	{
		return new AdvancedRefineryTileEntity();
	}

	@Override
	public void breakBlock(World par1World, int par2, int par3, int par4, Block par5, int par6)
	{
		final AdvancedRefineryTileEntity var7 = (AdvancedRefineryTileEntity) par1World.getTileEntity(par2, par3, par4);
