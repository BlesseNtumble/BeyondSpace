...
public class TeleportTypeSaturnRings implements ITeleportType
{
    @Override
    ...
    public Vector3 getPlayerSpawnLocation(WorldServer world, EntityPlayerMP player)
    {
        if (player != null)
        {
            ...
            do
            {
                ...
                {
                    bv3 = ((WorldProviderSaturnRings) world.provider).getClosestAsteroidXZ(x, 0, z, true);
                }
                ...
                if (bv3 != null)
                {
                    ...
                    ((WorldProviderSaturnRings) world.provider).removeAsteroid(bv3.x, bv3.y, bv3.z);
                }
