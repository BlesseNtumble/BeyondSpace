...
public class HCloud2 extends WorldGenerator {
	...
	public boolean generate_r0(World world, Random rand, int x, int y, int z) {
		if (!LocationIsValidSpawn(world, x + 4, y, z + 4)) {
			return false;
		}

		world.setBlock(x + 3, y + 0, z + 0, RegistrationsList.HCloud, 0, 3);
		...
		world.setBlock(x + 6, y + 0, z + 5, RegistrationsList.HCloud, 0, 3);
		...
		world.setBlock(x + 4, y + 0, z + 6, RegistrationsList.HCloud, 0, 3);
		world.setBlock(x + 5, y + 0, z + 6, RegistrationsList.HCloud, 0, 3);
		world.setBlock(x + 2, y + 0, z + 7, RegistrationsList.HCloud, 0, 3);
		world.setBlock(x + 3, y + 0, z + 7, RegistrationsList.HCloud, 0, 3);
		world.setBlock(x + 4, y + 0, z + 7, RegistrationsList.HCloud, 0, 3);
		world.setBlock(x + 3, y + 0, z + 8, RegistrationsList.HCloud, 0, 3);
	...
	public boolean generate_r1(World world, Random rand, int x, int y, int z)
{
		...
		world.setBlock(x + 6, y + 0, z + 6, RegistrationsList.HCloud, 0, 3);
		world.setBlock(x + 6, y + 0, z + 5, RegistrationsList.HCloud, 0, 3);
		world.setBlock(x + 6, y + 0, z + 4, RegistrationsList.HCloud, 0, 3);
		world.setBlock(x + 6, y + 0, z + 3, RegistrationsList.HCloud, 0, 3);
		world.setBlock(x + 6, y + 0, z + 2, RegistrationsList.HCloud, 0, 3);
		world.setBlock(x + 7, y + 0, z + 5, RegistrationsList.HCloud, 0, 3);
		world.setBlock(x + 7, y + 0, z + 4, RegistrationsList.HCloud, 0, 3);
		world.setBlock(x + 7, y + 0, z + 3, RegistrationsList.HCloud, 0, 3);
		world.setBlock(x + 8, y + 0, z + 4, RegistrationsList.HCloud, 0, 3);
		world.setBlock(x + 0, y + 1, z + 5, RegistrationsList.HCloud, 0, 3);
		world.setBlock(x + 0, y + 1, z + 4, RegistrationsList.HCloud, 0, 3);
		world.setBlock(x + 0, y + 1, z + 3, RegistrationsList.HCloud, 0, 3);
		world.setBlock(x + 1, y + 1, z + 6, RegistrationsList.HCloud, 0, 3);
