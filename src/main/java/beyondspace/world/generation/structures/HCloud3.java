...
public class HCloud3 extends WorldGenerator {
	...
	public boolean generate_r0(World world, Random rand, int x, int y, int z) {
		if (!LocationIsValidSpawn(world, x + 2, y, z + 5)) {
			return false;
		}
		...
		world.setBlock(x + 2, y + 0, z + 8, RegistrationsList.HCloud, 0, 3);
...
{
		if(!LocationIsValidSpawn(world, x + 5, y, z + 2))
		{
			return false;
		}
		...
		world.setBlock(x + 6, y + 0, z + 3, RegistrationsList.HCloud, 0, 3);
		world.setBlock(x + 6, y + 0, z + 2, RegistrationsList.HCloud, 0, 3);
		world.setBlock(x + 6, y + 0, z + 1, RegistrationsList.HCloud, 0, 3);
		...
		world.setBlock(x + 4, y + 3, z + 0, RegistrationsList.HCloud, 0, 3);
