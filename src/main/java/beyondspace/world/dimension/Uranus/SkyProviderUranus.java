...
public class SkyProviderUranus extends IRenderHandler
{
    ...
    private static final ResourceLocation rings = new ResourceLocation(ModInfo.MODID + ":" + "textures/gui/celestialbodies/uranusRings.png");
    
    public int starList;
    public int glSkyList;
    public int glSkyList2;

    public SkyProviderUranus()
    {
    ...
    public void render(float partialTicks, WorldClient world, Minecraft mc)
    {
        ...
        GL11.glColor4f(1.0F, 1.0F, 1.0F, 1.0F);
        FMLClientHandler.instance().getClient().renderEngine.bindTexture(rings);
        tessellator1.startDrawingQuads();
        tessellator1.addVertexWithUV(-f10, -100.0D, f10, 0.0D, 1.0D);
        tessellator1.addVertexWithUV(f10, -100.0D, f10, 1.0D, 1.0D);
        tessellator1.addVertexWithUV(f10, -100.0D, -f10, 1.0D, 0.0D);
