...
public class SkyProviderSaturnRings extends IRenderHandler
{
	private static final ResourceLocation saturnTexture = new ResourceLocation(GalacticraftCore.ASSET_PREFIX, "textures/gui/celestialbodies/saturn.png");
    ...
    public void render(float partialTicks, WorldClient world, Minecraft mc)
    {
        ...
        f10 = 6.5F;
        mc.renderEngine.bindTexture(SkyProviderSaturnRings.sunTexture);
        tessellator1.startDrawingQuads();
        ...
        GL11.glRotatef(90.0F, 100.0F, 1.0F, 0.0F);
        GL11.glRotatef(0F, 1.0F, 0.0F, 0.0F);
        GL11.glColor4f(1.0F, 1.0F, 1.0F, 1F);
        FMLClientHandler.instance().getClient().renderEngine.bindTexture(saturnTexture);
        tessellator1.startDrawingQuads();
    ...
    private void renderStars() {
        ...
        for (int starIndex = 0; starIndex < (ConfigManagerCore.moreStars ? 35000 : 6000); ++starIndex) {
            ...
            double f10 = var4 * var4 + var6 * var6 + var8 * var8;

            if (f10 < 1.0D && f10 > 0.01D) {
                f10 = 1.0D / Math.sqrt(f10);
                var4 *= f10;
                var6 *= f10;
                var8 *= f10;
