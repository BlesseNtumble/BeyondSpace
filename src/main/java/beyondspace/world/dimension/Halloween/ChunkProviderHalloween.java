...
public class ChunkProviderHalloween extends ChunkProviderGenerate implements IChunkProvider {

    private final Random rand;
    
    final Block topBlockID = Blocks.grass;
    final Block fillBlockID = Blocks.mossy_cobblestone;
    final Block lowerBlockID = Blocks.gravel;
    ...
    private BiomeGenBase[] biomesForGeneration = { BiomeGenBaseHalloween.halloween };
    ...
    public ChunkProviderHalloween(World par1World, long par2, boolean par4) {
